...
coluna_excel=2;
tipoclass='TFE';
[cell_cmd_plot]=mainEMG_testes(canais_avaliar,canal_ext,canal_flex,cell_sinais,cell_acel,cell_sinal_ac,voluntario,tipoclass,tipodet);
