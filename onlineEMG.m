...
%% determina a raz„o r_Yt de acordo com o n˙mero de canais considerados
canal_ext1=1;
canal_flex1=2;
canal_ext2=3;
canal_flex2=4;
...
if tipoclass=='TFE',
    ...
    %% determina qual o resultado da detecÁ„o final (1:extensao,2:flexao,0:repouso)
    comando=0; 
    if maior==1,
        if r_Yt<limiar,
            comando=2;%flexao
...
>>>>>>> parent of 3b7c81e... Inclus√£o do classificador SVM + altera√ß√µes necess√°rias no programa execut√°vel
    end
