...
[cell_cmd_plot]=mainEMG_todos(canais_reais,canal_ext,canal_flex,cell_sinais,cell_acel,voluntario,tipoclass);
[prec_ext,prec_flex,sens_ext,sens_flex,overall_acc]=avalia_resultados_blocos(N,voluntario,cell_acel,cell_cmd_plot);
